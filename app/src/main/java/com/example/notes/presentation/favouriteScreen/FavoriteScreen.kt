package com.example.notes.presentation.favouriteScreen
...
class FavoriteScreen(private val selectedIndex: Int,private val noteViewModel: NoteViewModel) :Screen{
@Composable
override fun Content() {
    FavoriteScreenDeign()
}
@Composable
fun FavoriteScreenDeign(){
    ...
    if (notes.value?.isEmpty() == true){
        EmptyFavouriteScreen(navigator,showInfoDialog,backgroundColor)} else{
        FavoriteScreenDesign(navigator,showInfoDialog,backgroundColor,selectedIndex,notes)}
}
@Composable
fun FavoriteScreenDesign(
    navigator: Navigator,
    ...
    Box(modifier = Modifier
        ...
        LazyColumn(modifier = Modifier
            ...
            items(notes.value?.filter { it.isFavourite }?: emptyList(), key = {it.id}){ note->
